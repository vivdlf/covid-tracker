...
<body>
	...
	<div class = "ob">
	<form name='frmSearch' action='' method='post' onSubmit="return submitSearch(event)">
		<div class="search">
		...
		<table class='tbl-qa' id="tutorial-body">
			<thead>
				<tr>
					...
					<th class='table-header' >Date of Diagnosis</th>
					<th class='table-header' >Update Health Status</th>
				</tr>
			</thead>
			<tbody id='table-body'>
	<?php
if (! empty($result)) {
    ...
    ?>
		<tr class='table-row'>
			...
			<td class="c"><textarea name='comment' > </textarea></td>
			<td class="c"><input type="date" value="<?php echo date('Y-m-d'); ?>"></td>
